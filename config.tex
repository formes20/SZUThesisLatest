...
\usepackage{xeCJKfntef}% underline for CJK
\usepackage{listings}
\setCJKfamilyfont{song}[AutoFakeBold=2]{SimSun.ttf}
\AtBeginDocument{
	\DeclareCaptionFont{songti}{\CJKfamily{song}}
	% 更改标号为短横线连接
